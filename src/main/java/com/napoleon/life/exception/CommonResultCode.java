...
public enum CommonResultCode {
	...
	COST_DETAIL_NOT_FOUND("200014", "COST_DETAIL_NOT_FOUND", "您的消费详情信息不存在"),
	COST_TYPE_NOT_FOUND("200015", "COST_TYPE_NOT_FOUND", "消费类型不存在"),
	COST_ORDER_NOT_FOUND("200016", "COST_ORDER_NOT_FOUND", "消费订单不存在"), 
